...
class AlohaEnv(DirectRLEnv):
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        out_of_bounds = torch.any(torch.tensor([True, True]))#torch.abs(self.joint_pos[:, self._cart_dof_idx]) > self.cfg.max_cart_pos, dim=1)
